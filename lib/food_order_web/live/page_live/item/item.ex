defmodule FoodOrderWeb.PageLive.Item do
  ...
  defp product_info(assigns) do
    ...
    <div class="mt-6 flex items-center justify-around">
      ...
      <button class="border-2 py-1 px-6 rounded-full border-orange-500 text-orange-500 transition hover:bg-orange-600 hover:text-neutral-100">
        <span>+</span>
        <span>add</span>
      </button>
    </div>
  ...
  defp product_details(assigns) do
    ...
    <span class="bg-neutral-200 py-1 px-4 rounded-full uppercase text-xs"><%= @size %></span>
    """
  end
end
